...
def index():
    manufacturer = requests.get("http://34.105.217.148:5001/manufacturer")
    vehicle_type = requests.get("http://34.105.217.148:5002/vehicle_type")
    dictionary = {'manufacturer': manufacturer.text, 'vehicle_type': vehicle_type.text}
    total_price = requests.post("http://34.105.217.148:5003/total_price", json=dictionary)
